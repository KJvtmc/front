...
class UserName extends React.Component {
  constructor(props) {
    super(props);
    this.state = {name: props.ctx.userService.name, userService: props.ctx.userService};
    props.ctx.userService.updateMe = () => this.setState({name: this.state.userService.name});
  }
  render() {
...
var AppContainer = (props) => {
  var ctx = useContext(HistoryContext);
  return (<div>
    <div>
      <Link to='/'>Home</Link> |&nbsp;
